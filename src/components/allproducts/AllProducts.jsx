...
function AllProducts() {
    ...
    const getProducts = () => {
        ...
        promiseObject.then((res) => {
            ...
            // setAllProducts(res.data);  //[{},{},.......] 20 objects inside an array
            ...
            <div className="allProductsData">
                {
                    productsData.map(function (product) {
                        return <Card id={product.id} image={product.image} title={product.title} price={product.price} rating={product.rating.rate} />;
                    })
                }
            </div>
        </div>
